 ...
 * @see app/Http/Controllers/TaskController.php:123
 * @route '/tasks/{task}'
 */
 ...
 * @see app/Http/Controllers/TaskController.php:137
...
const TaskController = { index, create, store, show, edit, update, destroy, changeStatus, toggleSubTask }
